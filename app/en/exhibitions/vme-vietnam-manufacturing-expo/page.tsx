            ...
            <div className="absolute inset-0 h-[800px] flex items-center justify-center mt-14">
               <div className="max-w-[1136px] w-full mx-auto px-4 xl:px-0 h-fit flex flex-col items-center gap-10">
                  ...
                  <div className="flex flex-col lg:flex-row gap-4 lg:gap-[.9375rem] justify-around items-center">
                     ...
                     <div className="">
                           <Link href={`../../${lang}/exhibitions/vme-vietnam-manufacturing-expo/exhibitor-registration`} className="flex items-center bg-green-600 hover:bg-green-700 gap-[.625em] p-3 rounded-lg text-white border-b-4 border-green-900" aria-label="Exhibitor Registration">
                              <div className="flex items-center justify-center">
                     ...
                     <div className="">
                           <Link href={`../../${lang}/exhibitions/vme-vietnam-manufacturing-expo/visitor-registration`} className="flex items-center bg-green-600 hover:bg-green-700 gap-[.625em] p-3 rounded-lg text-white border-b-4 border-green-900" aria-label="Visitor Registration">
                              <div className="flex items-center justify-center">
